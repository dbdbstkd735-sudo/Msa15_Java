...
/**
 * 람다식 사용하기 1. 함수형 인터페이스 정의 *@FunctionalInterface 어노테이션 지정 *추상 메소드 1개만 정의 2. 람다식
 * 익명 합수를 정의하여 인터페이스에 선언 3.람다식 호출
 */
...
public class Ex01_LambdaFormat {
	...
	public static void main(String[] args) {
		...
		//* return 문만 이있을 떈, {} 생략 불가
		FuncInterface4 fi6 =  (a, b) -> a + b; 
		// 반환 값만 있을 땐, return , {} 둘 다 생략해야 한다.
